...
public class StyleBuilder {
	...
	protected ImmutableMap<String,String> DATE_PATTERNS = ImmutableMap.of(
			"US", "mm/dd/yyyy", "GB", "dd/mm/yyyy", "FR", "yyyy-mm-dd");
	...
	public XSSFCellStyle getInfosheetBorderStyle() {
	    return this.fill(Colors.LILAC).alignment(CellStyle.ALIGN_LEFT).build();
	}
	public XSSFCellStyle getInfosheetHeaderStyle() {
        return this.fill(Colors.LILAC).alignment(CellStyle.ALIGN_LEFT).bold().build();
    }
	/**
